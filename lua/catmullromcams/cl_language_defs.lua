language.Add("Tool.catmullrom_camera.name", "CRCC: Track Layout")
...
language.Add("Tool.catmullrom_camera_duration.name", "CRCC: Duration Editor")
...
language.Add("Tool.catmullrom_camera_numpad_trigger.name", "CRCC: Numpad Trigger Editor")
...
language.Add("Tool.catmullrom_camera_looker.name", "CRCC: Smart Look Modifier")
...
language.Add("Tool.catmullrom_camera_map_io.name", "CRCC: Map I/O Modifier")
...
language.Add("Tool.catmullrom_camera_linker.name", "CRCC: Track Linker")
...
language.Add("Tool.catmullrom_camera_hitchcock.name", "CRCC: Hitchcock Effect")
